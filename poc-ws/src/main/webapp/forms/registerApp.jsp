...
<br/>
     <form action="/poc-ws/oauth/registerProvider"
       ...
       <table>    
        <tr>
            ...
            <td>
              <input type="text" name="appName" size="50" value="Poc Registration"/>
            </td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
        ...
        <tr>
            ...
            <td>
              <input type="text" size="50" name="appURI" value="http://localhost:8080/poc-web/pages"/>
            </td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
        ...
        <tr>
            ...
            <td>
              <input type="text" size="50" name="appRedirectURI" value="http://localhost:8080/poc-web/pages/fileupload.faces"/>
            </td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
